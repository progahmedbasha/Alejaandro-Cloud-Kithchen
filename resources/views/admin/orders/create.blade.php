    ...
    <div class="row">
        <div class="col-xl-6 col-lg-8" style="padding-right: 0px;">
         ...
         <form action="{{route('orders.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="form-label d-flex justify-content-between align-items-center" for="client_id">
                                    <span>اسم العميل :</span>
                                    <a href="{{ route('clients.create') }}" target="_blank" class="btn btn-sm btn-outline-primary" title="إضافة عميل جديد">
                                        +</i>
                                    </a>
                                </label>

                                <select class="form-control select2-client" name="client_id" id="client_id">
                            ...
                            <div class="col">
                                <label class="form-label" for="email"> الخدمة :</label>
...
<div class="row" style="justify-content:center;">
    <div class="col-xl-8 col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">الأوردرات : </h4>
                </div>
            </div>
            <hr class="hr-horizontal">
            <div class="card-body" style="max-height: 50%;">
                    ...
                    <table id="user-list-table" class="table table-striped" role="grid">
                        ...
                        <tbody>
                            ...
                            <tr @if($active_table->is_printed) style="background-color: bisque;" @endif>
                                ...
                                <td>{{ $active_table->client->name }} </td>
